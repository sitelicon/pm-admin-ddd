...
export const es = {
  ...
  [tokens.nav.categoryList]: 'Categorías',
  ...
  [tokens.nav.list]: 'Listado',
  [tokens.nav.login]: 'Acceso',
  [tokens.nav.logistics]: 'Logística',
  [tokens.nav.announcements]: 'Anuncios Tienda',
  [tokens.nav.layoutHomeWeb]: 'Maquetación Web',
  [tokens.nav.sliderLayout]: 'Diseño del control deslizante',
  [tokens.nav.mail]: 'Correo',
  [tokens.nav.management]: 'Gestión',
  [tokens.nav.orderList]: 'Pedidos',
  [tokens.nav.overview]: 'Inicio',
