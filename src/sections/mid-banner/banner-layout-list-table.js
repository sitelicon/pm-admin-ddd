...
export const MidSeasonBannerListTable = (props) => {
  const {
    onPageChange,
    onRowsPerPageChange,
    midBannerLayout,
    midBannerLayoutCount,
    page,
    rowsPerPage,
    loading,
    handleRemove,
  ...
  const { deselectAll, deselectOne, selectAll, selectOne, selected } =
    useSelectionModel(midBannerLayout);
  ...
  const selectedAll = selected.length === midBannerLayout.length;
  const selectedSome =
    selected.length > 0 && selected.length < midBannerLayout.length;
      ...
      <Scrollbar>
        <Table stickyHeader>
          ...
          <TableBody>
            ...
            {!loading &&
              midBannerLayout.map((bannerTextLayout) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{bannerTextLayout.title_admin}</TableCell>
                    <TableCell align="right">
                      <Link
                        component={NextLink}
                        href={`${paths.adminContent.home.midbanner}/${bannerTextLayout.id}`}
...
MidSeasonBannerListTable.propTypes = {
  onPageChange: PropTypes.func.isRequired,
  onRowsPerPageChange: PropTypes.func,
  midBannerLayout: PropTypes.array.isRequired,
  midBannerLayoutCount: PropTypes.number.isRequired,
