                  ...
                  action={
                    <CSVLink
                      data={report.map((row) => ({
                        ...
                        sales_total: numeral(row.sales_total).format('$0,0.00'),
                        sales_tax: numeral(row.sales_tax).format('$0,0.00'),
                        sales_shipping: numeral(row.sales_shipping).format(
                          '$0,0.00',
                        ),
                        sales_discount: numeral(
                          Math.abs(row.sales_discount),
                        ).format('$0,0.00'),
                      }))}
                      headers={[
                      ...
                      <TableBody>
                        {report.map((row) => (
                          <TableRow key={row.interval} hover>
                            ...
                            <TableCell>
                              {numeral(row.sales_total).format('$0,0.00')}
                            </TableCell>
                            <TableCell>
                              {numeral(row.sales_tax).format('$0,0.00')}
                            </TableCell>
                            <TableCell>
                              {numeral(row.sales_shipping).format('$0,0.00')}
                            </TableCell>
                            <TableCell>
                              {numeral(Math.abs(row.sales_discount)).format(
                                '$0,0.00',
                              )}
                            </TableCell>
