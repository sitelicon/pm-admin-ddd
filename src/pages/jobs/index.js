...
import { CompanyCard } from '../../sections/jobs/company-card';
import { JobListSearch } from '../../sections/jobs/job-list-search';
...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>Dashboard: Job Browse | PACOMARTINEZ</title>
      </Head>
      <Box
        component="main"
        sx={{
