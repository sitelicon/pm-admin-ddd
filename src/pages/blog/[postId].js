...
import { PostComment } from '../../sections/blog/post-comment';
import { PostCommentAdd } from '../../sections/blog/post-comment-add';
import { PostNewsletter } from '../../sections/blog/post-newsletter';
import { PostContent } from '../../sections/blog/post-content';
...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>Blog: Post Details | PACOMARTINEZ</title>
      </Head>
      <Box
        component="main"
        sx={{
