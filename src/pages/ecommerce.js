...
import { EcommerceCostBreakdown } from '../sections/ecommerce/ecommerce-cost-breakdown';
import { EcommerceSalesByCountry } from '../sections/ecommerce/ecommerce-sales-by-country';
...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>Resumen | PACOMARTINEZ</title>
      </Head>
      <Box
        component="main"
        sx={{
